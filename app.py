...
df = pd.read_csv("https://raw.githubusercontent.com/Coding-with-Adam/arms-trade/refs/heads/main/country%20trade%20register.csv")
...
app.layout = [
    ...
    dcc.RangeSlider(
        df["Delivery year"].min(),
        df["Delivery year"].max(),
        step=1,
